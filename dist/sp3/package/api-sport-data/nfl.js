...
class d {
   ...
   */
  async initialize() {
    return this.$state.loading = !0, this.$debugging ? this.$state = await this.initState() : this.$state = await this.$cache.get(
